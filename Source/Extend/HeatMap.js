...
define([
     ...
     * 热力图类
     * @param options 热力图参数
     * @param options.scene 地球场景
     * @param options.bbox  热力图边界范围
     * @param options.gradient  热力图渐进
     * @param options.maxOpacity  热力图最大透明度
     * @param options.minOpacity  热力图最小透明度
     * @param options.blur  热力图模糊度
     * @param options.radius  热力图热点半径
     * @constructor
     */
    function HeatMap(options) {
        ...
        this._hmoptions.radius = defaultValue(options.radius, HeatMapDefaults.radiusFactor);
        ...
        this._heatmap = h337.create(Object.assign(this._hmoptions, {radius: 200}));
